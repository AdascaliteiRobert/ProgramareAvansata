...
//    }
    ...
    Location[] locations = new Location[5];
        ...
        System.out.println();
        locations[1] = new Airport("Henri Coanda", 4, 3, 5);
        ...
        locations[4] = new City("Bucuresti", 2, 4, 2_000_000);
        locations[3] = new GasStation();
        locations[3].setName("Gas1");
        locations[3].setX(3);
        locations[3].setY(5);
        Road[] roads = new Road[2];
        roads[0] = new Express("A3", 120, locations[0], locations[2]);
        ...
        System.out.println();
        roads[1] = new Highway("A4", 230, locations[0], locations[3]);
        Instance pb = new Instance(locations, roads, locations[2], locations[4]);
        pb.connectedLocations(locations[0], locations[2]);
...
//        }
//
//        Instance pb = new Instance(locations, roads, locations[ran.nextInt(601)], locations[ran.nextInt(601)]);
//
//
//
